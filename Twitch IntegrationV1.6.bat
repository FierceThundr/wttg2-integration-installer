...
::Welcome to the Game 2+ Installer
...
::==============================================About
:about
Title [WTTG2+ Manager] About
CLS
echo.
echo.
echo                    [About the Mod]
echo.
echo     The Welcome to the Game II+ mod is a project 
echo   created by nasko222 which brings a feature from the 
echo   first game into the second.
echo.
...
::==============================================Troubleshooting
:troubleshoot
Title [WTTG2+ Manager] Troubleshooting
CLS
echo.
echo.
...
Title [WTTG2+ Manager] Mod Update
call :end
CLS
echo.
echo.
...
if not "%ans:~-19%"=="Assembly-CSharp.dll" (if not "%ans:~-23,15%%ans:~-4%"=="Assembly-CSharp.dll" (echo.&echo.&echo   Please enter a valid response...&echo.&echo   Please be aware the file must be named&echo   "Assembly-CSharp.dll" to be accepted.&echo.&echo.&timeout 2 /nobreak 1>NUL&goto modupdate ))
...
if not exist "%data2:~0,-9%Twitch" (goto installerror )
if not exist "%data2:~0,-9%WTTG2.exe" (goto installerror )
Title [WTTG2+ Manager] Update Information
call :end
CLS
echo.
echo.
...
:update1
Title [WTTG2+ Manager] Update Username
CLS
echo.
echo.
...
:update2
Title [WTTG2+ Manager] Update Oauth Code
CLS
echo.
echo.
...
if not exist "%data2:~0,-9%Twitch" (goto installerror )
if not exist "%data2:~0,-9%WTTG2.exe" (goto installerror )
Title [WTTG2+ Manager] Toggling Integration...
CLS
echo.
echo.
if "%enabled%"=="0" (
...
Title [WTTG2+ Manager] Clearing Sound Cache...
CLS
echo.
echo.
...
::==============================================Installation
:installquit
Title [WTTG2+ Manager] Closing Installer...
CLS
echo.
echo.
...
if defined data2 (if exist "%data2:~0,-9%Twitch" (
  Title [WTTG2+ Manager] Install paused...
  :installmulti
  CLS
  echo.
  echo.
...
Title [WTTG2+ Manager] Install Step 1/5
:step1
CLS
echo.
echo.
...
if not "%ans:~-19%"=="Assembly-CSharp.dll" (if not "%ans:~-23,15%%ans:~-4%"=="Assembly-CSharp.dll" (echo.&echo.&echo   Please enter a valid response...&echo.&echo   Please be aware the file must be named&echo   "Assembly-CSharp.dll" to be accepted.&echo.&echo.&timeout 2 /nobreak 1>NUL&goto step1 ))
set data1=%ans%

Title [WTTG2+ Manager] Install Step 2/5
:step2
CLS
echo.
echo.
...
Title [WTTG2+ Manager] Install Step 4/5
:step4
CLS
echo.
echo.
...
Title [WTTG2+ Manager] Install Step 5/5
:step5
CLS
echo.
echo.
...
Title [WTTG2+ Manager] Installing...
echo.
echo.
echo     Installing...
echo.
...
Title [WTTG2+ Manager] Installation Complete^^!
:installdone
CLS
echo.
echo.
